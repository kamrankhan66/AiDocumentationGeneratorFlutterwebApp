...
''';
  ...
  Future<Documentation> generateFullDocumentation(
    ...
    try {
      ...
      onProgress?.call(AppConstants.structureAgent, 'Analyzing architecture...');
      ...
      onProgress?.call(AppConstants.suggestionAgent, 'Generating improvement suggestions...');
  ...
  Future<String> explainFile(String filename, String content, ProjectInfo projectInfo) async {
    final prompt = '''
${AppConstants.systemPrompt}
